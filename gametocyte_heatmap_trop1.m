function [ plot_mat,name_group ] = gametocyte_heatmap_trop1( early, late, g_names, control1, c_names1)
% [r,c]=size(early); 
...
[r,c]=size(early); 
c_mat=zeros(r,3); %new control matrix 
...
%cmap='jet'; 
H=HeatMap(plots,'ColumnLabels',x,'RowLabels',name_group, 'DisplayRange', 1, 'Colormap', cmap, 'Symmetric','true'); 
plot(H);
print (gcf, '-dpng','gametocyte_heatmap.png'); 
print (gcf, '-depsc2', [label 'gametocyte_heatmap.eps']); 
